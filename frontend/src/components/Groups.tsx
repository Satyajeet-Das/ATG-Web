    ...
    <>
      <div className="p-3 rounded bg-white" style={{ width: "300px" }}>
        ...
        <p className="d-flex text-muted small mb-4">
          <img
            className="d-flex px-1 align-items-start"
            src={Info}
            alt="info"
          />
          <div>
